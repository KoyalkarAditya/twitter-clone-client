      ...
      <div className=" grid grid-cols-12 h-screen w-screen px-56">
        <div className=" col-span-3  justify-start pt-8  pr-4">
          ...
          <div className=" my-4  pr-4">
            ...
            <button className=" w-full font-semibold rounded-full p-3  mt-4 bg-[#1d9bf0] hover:bg-[#1a8cd8]">
              Post
            </button>
          </div>
        </div>
        <div className=" col-span-6  border-gray-600 border-r-[1px] border-l-[1px]"></div>
